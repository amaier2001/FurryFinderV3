...
char url[250] = {0}; //No idea how long it should be, I just sent it, sorry profe

const int UDID = 80085;
int run = 0;
...
/**
	  while(run == 0)
	  {
		  //HAL_Delay(120000); //FAILSAFE, should NOT run
		  run = 1;
	  } //I'm sorry
**/
